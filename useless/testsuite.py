...
class TestSuite:
    ...
    def run_testsuite(self, http):
        ...
        for testcase_id in testcases_id_list_for_testsuit[:]:
            ...
            testcase_obj = TestCase(testcase_id, testcase_name, testcase_steps, testcase_isactive, self.project_name, testsuite_id, tc_external_id, preconditions)
            ...
            testplan = '无计划'
            data = (executed_history_id, testcase_id, testcase_name, testsuite_name, testplan, self.project_name, 'Block','0000-00-00 00:00:00', tc_external_id)
            ...
            data = (testcase_run_result[0], run_time, case_executed_history_id, executed_history_id, testcase_id, self.project_name,
